...
def _build_general_transforms(general_cfg: dict) -> list[A.BasicTransform]:
    return [
        ...
        A.Affine(
            scale=(1.0 - float(general_cfg.get("scale_limit", 0.10)),
                1.0 + float(general_cfg.get("scale_limit", 0.10))),
            translate_percent={
                "x": (-float(general_cfg.get("shift_limit", 0.0625)),
                    float(general_cfg.get("shift_limit", 0.0625))),
                "y": (-float(general_cfg.get("shift_limit", 0.0625)),
                    float(general_cfg.get("shift_limit", 0.0625))),
            },
            rotate=(-int(general_cfg.get("rotate_limit", 20)),
                    int(general_cfg.get("rotate_limit", 20))),
            shear=0.0,
